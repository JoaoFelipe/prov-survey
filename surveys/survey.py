...
from .forms import Country, Institution, Comments
...
TITLES = {
    'p1': lazy_gettext('What is your educational level?'),
    'p2': lazy_gettext('How many scientific experiments have you ever performed on computational environments?'),
    'p3': lazy_gettext('What are your scientific domains? (check all that apply)'),
    'p4': lazy_gettext('How much experience do you have in running scientific experiments on computational environments?'),
    'p5': lazy_gettext('In which roles have you performed computational experiments? (check all that apply)'),
    'p6': lazy_gettext('What is your country of residence?'),
    't1': lazy_gettext('What are your preferred/more often used tools you use to run experiments? (check up to 3 tools)'),
    ...
    'c1': lazy_gettext('Would you accept being contacted about the possibility of participating in a practical experimental study about integrated provenance analysis? The study is in the context of a PhD thesis about provenance integration.'),
